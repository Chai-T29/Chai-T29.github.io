...
- **Flask Dashboard:** Interactive map and ZIP selector for side-by-side forecast charts, allowing users to input mortgage rate and down payment.  
  <!-- Insert Figure 2: Flask Visualization here -->
- **Tableau Dashboard:** Choropleth map illustrating rent vs. buy cost-effectiveness, with adjustable parameters to explore regional patterns.  
  <!-- Insert Figure 3: Tableau Visualization here -->
